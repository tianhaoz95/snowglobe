...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1836583923;
...
fn wire__crate__api__simple__check_backend_impl(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::api::simple::check_backend())?;
                    Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__simple__experimental_completion_with_pte_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "experimental_completion_with_pte",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_pte_path = <String>::sse_decode(&mut deserializer);
            let api_prompt = <String>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok =
                        Result::<_, ()>::Ok(crate::api::simple::experimental_completion_with_pte(
                            api_pte_path,
                            api_prompt,
                        ))?;
                    Ok(output_ok)
...
fn wire__crate__api__simple__generate_response_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
...
fn wire__crate__api__simple__get_last_accepted_count_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(
                        crate::api::simple::get_last_accepted_count(api_session_id),
                    )?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__api__simple__init_engine_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
...
fn wire__crate__api__simple__init_session_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::api::simple::init_session())?;
                    Ok(output_ok)
                })())
            }
        },
...
impl SseDecode for crate::api::simple::BackendType {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <i32>::sse_decode(deserializer);
        return match inner {
            0 => crate::api::simple::BackendType::Burn,
            1 => crate::api::simple::BackendType::ExecuTorch,
            2 => crate::api::simple::BackendType::LlamaCpp,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__simple__check_backend_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__api__simple__experimental_completion_with_pte_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        4 => wire__crate__api__simple__get_last_accepted_count_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        5 => wire__crate__api__simple__get_model_info_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__simple__init_engine_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__simple__init_session_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::simple::BackendType {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::simple::BackendType
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::simple::BackendType>
    for crate::api::simple::BackendType
{
    fn into_into_dart(self) -> crate::api::simple::BackendType {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::simple::BackendType {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(
            match self {
                crate::api::simple::BackendType::Burn => 0,
                crate::api::simple::BackendType::ExecuTorch => 1,
                crate::api::simple::BackendType::LlamaCpp => 2,
                _ => {
                    unimplemented!("");
                }
            },
