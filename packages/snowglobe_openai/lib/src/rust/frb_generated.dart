...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
        stem: 'rust_lib_snowglobe_openai',
...
abstract class RustLibApi extends BaseApi {
  Future<String> crateApiChatCompletion({required String requestJson});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta: kCrateApiChatCompletionStreamConstMeta,
          argValues: [requestJson, sink],
          apiImpl: this,
        ),
      ),
    );
  ...
  TaskConstMeta get kCrateApiChatCompletionStreamConstMeta =>
      const TaskConstMeta(
        debugName: "chat_completion_stream",
        argNames: ["requestJson", "sink"],
      );
